...
export const productosIniciales: Producto[] = [
  ...
  { id: "p4", nombre: "Gorra Deportiva Aerofit", categoria: "Accesorios", talla: "Único", color: "Azul", precio: 29.9, stock: 4 },
  { id: "p5", nombre: "Mochila Gym Impermeable", categoria: "Accesorios", talla: "Único", color: "Negro", precio: 89.9, stock: 3 },
];
...
export const pedidosIniciales: Pedido[] = [
  ...
  },
  {
    ...
    cliente: { nombre: "Ana Rodríguez", telefono: "934567890", direccion: "Agencia Shalom - Av. España 1020, Trujillo" },
    ...
    total: 109.7, costoDelivery: 15, descuento: 5,
  ...
  },
  {
    ...
    cliente: { nombre: "Rosa Huanca", telefono: "901234567", direccion: "Agencia Olva - Calle Mercaderes 402, Arequipa" },
  ...
  },
  {
    ...
    cliente: { nombre: "Miguel Palacios", telefono: "945678901", direccion: "Agencia Marvisur - Av. Sol 500, Cusco" },
